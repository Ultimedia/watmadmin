<?php
	...
	$dbc = getDBConnection();		
	$sql = "SELECT * FROM watm_user_challenges LEFT JOIN watm_challenges ON watm_user_challenges.challenge_id = watm_challenges.challenge_id WHERE user_id =" . $user_id . " AND status < 99";
